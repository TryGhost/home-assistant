...
async def test_setup_entry_auth_error(
    ...
    with patch("custom_components.ghost.GhostAdminAPI", return_value=mock_ghost_api_auth_error):
        await hass.config_entries.async_setup(mock_config_entry.entry_id)
        await hass.async_block_till_done()
...
async def test_setup_entry_connection_error(
    ...
    with patch(
        "custom_components.ghost.GhostAdminAPI", return_value=mock_ghost_api_connection_error
    ):
        await hass.config_entries.async_setup(mock_config_entry.entry_id)
        await hass.async_block_till_done()
...
async def test_unload_entry(
    ...
    mock_ghost_api.close.assert_called_once()
...
async def test_setup_entry_with_webhooks(
    ...
    with (
        patch("custom_components.ghost.GhostAdminAPI", return_value=mock_ghost_api),
        patch("custom_components.ghost.coordinator.GhostAdminAPI", return_value=mock_ghost_api),
        patch("custom_components.ghost.get_url", return_value="https://my.home-assistant.io"),
    ):
        await hass.config_entries.async_setup(mock_config_entry.entry_id)
        await hass.async_block_till_done()
...
async def test_setup_entry_with_http_url_no_webhooks(
    ...
    with (
        patch("custom_components.ghost.GhostAdminAPI", return_value=mock_ghost_api),
        patch("custom_components.ghost.coordinator.GhostAdminAPI", return_value=mock_ghost_api),
        patch("custom_components.ghost.get_url", return_value="http://192.168.1.100:8123"),
    ):
        await hass.config_entries.async_setup(mock_config_entry.entry_id)
        await hass.async_block_till_done()
...
async def test_unload_entry_with_webhooks(
    ...
    mock_ghost_api.close.assert_called()
